...
Goal: -
Design a Clous posture Dashboard that gives a simple, centralized way to view, filter and prioritize cloud misconfigurations across multiple cloud accounts
